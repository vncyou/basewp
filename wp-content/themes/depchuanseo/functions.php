...
function dcs_scripts() {
	wp_enqueue_style( 'dcs-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'dcs-style', 'rtl', 'replace' );

	wp_enqueue_script( 'dcs-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
